...
for name, page in pages.items():
    ...
    if name == "cover":
        ...
        button_fb = tk.Button(canvas, image=images["facebook"], borderwidth=0,
                              command=lambda: openFacebook())  # Tool button
        button_fb.config(activebackground=defaultbg)
        canvas.create_window(92.5, 700, window=button_fb)  # Facebook button position

        button_linkedin = tk.Button(canvas, image=images["linkedin"], borderwidth=0, command=lambda: openLinkedIn())
        ...
        button_twitter = tk.Button(canvas, image=images["twitter"], borderwidth=0, command=lambda: openTwitter())
        ...
        button_login_signup = tk.Button(canvas, text='Register', borderwidth=0, font='times 12 underline',
                                        fg='#243746', command=lambda: t.show_frame(pages["login"]["frame"],
                                                                                   pages["signup"]["frame"],
                                                                                   "Sign up", root))
        ...
        button_login = tk.Button(canvas, text="LOGIN", font='times 12 bold', fg="#243746",
                                 command=lambda: t.show_frame(pages["login"]["frame"], pages["home"]["frame"],
                                                              "Home", root))
        ...
        button_tool = tk.Button(canvas, image=images["toolIcon"], borderwidth=0,
                                command=lambda: t.show_frame(pages["home"]["frame"], pages["interfaces"]["frame"],
        ...
        button_tutorial = tk.Button(canvas, image=images["tutorialIcon"], borderwidth=0,
                                    command=lambda: t.show_frame(pages["home"]["frame"], pages["tutorials"]["frame"],
        ...
        button_manual = tk.Button(canvas, image=images["manualIcon"], borderwidth=0,
                                  command=lambda: t.show_frame(pages["home"]["frame"], pages["manual"]["frame"],
        ...
        button_settings = tk.Button(canvas, image=images["settingsIcon"], borderwidth=0,
                                    command=lambda :t.show_frame(pages["home"]["frame"], pages["settings"]["frame"],
        ...
        button_logout = tk.Button(canvas, image=images["logoutIcon"], borderwidth=0,
                                  command=lambda: t.show_frame(pages["home"]["frame"], pages["login"]["frame"],
        ...
        button_home = tk.Button(canvas, image=images["homeIcon"], borderwidth=0,
                                command=lambda: t.show_frame(pages["interfaces"]["frame"], pages["home"]["frame"],
        ...
        button_interfaces_scan = tk.Button(canvas, text="Scan", font='Times 20 bold', fg="#4D4D4D",
                                           command=lambda: t.show_frame(pages["interfaces"]["frame"],
        ...
        button_home_network = tk.Button(canvas, image=images["homeIcon"], borderwidth=0,
                                        command=lambda: t.show_frame(pages["networks"]["frame"],
        ...
        button_back = tk.Button(canvas, image=images["back"], borderwidth=0,
                                command=lambda: t.show_frame(pages["signup"]["frame"], pages["login"]["frame"],
                                                             "Login", root))
        ...
        button_home_tutorials = tk.Button(canvas, image=images["homeIcon"], borderwidth=0,
                                          command=lambda: t.show_frame(pages["tutorials"]["frame"],
        ...
        button_logout = tk.Button(canvas, image=images["logoutIcon"], borderwidth=0,
                                  command=lambda: t.show_frame(pages["tutorials"]["frame"], pages["login"]["frame"],
                                                               "Login", root))  # logout button
        button_logout.config(activebackground=defaultbg)
        canvas.create_window(430, 748, window=button_logout, height=90, width=90)  # logout button postion
        ...
        button_home_manual = tk.Button(canvas, image=images["homeIcon"], borderwidth=0,
                                       command=lambda: t.show_frame(pages["manual"]["frame"],
                                                                    pages["home"]["frame"], "Home", root))
        ...
        button_logout = tk.Button(canvas, image=images["logoutIcon"], borderwidth=0,
                                  command=lambda: t.show_frame(pages["manual"]["frame"], pages["login"]["frame"],
                                                               "Login", root))  # logout button
        button_logout.config(activebackground=defaultbg)
        canvas.create_window(430, 748, window=button_logout, height=90, width=90)  # logout button postion
        ...
        button_home_settings = tk.Button(canvas, image=images["homeIcon"], borderwidth=0,
                                         command=lambda: t.show_frame(pages["settings"]["frame"],
                                                                      pages["home"]["frame"], "Home", root))
        ...
        button_logout = tk.Button(canvas, image=images["logoutIcon"], borderwidth=0,
                                  command=lambda: t.show_frame(pages["settings"]["frame"], pages["login"]["frame"],
                                                               "Login", root))  # logout button
        button_logout.config(activebackground=defaultbg)
