...
function top(){
        ...
        echo -e "$red[~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~]"
        echo -e "$red[                                                      ]"
  echo -e "$red[  $red    PPTD" "${yellow} ${red}  < P""${yellow}PTD" "${red}I""${yellow}s" "${red}T""${yellow}he ""${red}F""${yellow}uture >     "              ${blue}"    ]"
        echo -e "$blue[                                                      ]"
